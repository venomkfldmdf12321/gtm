                    ...
                    `<div>
                        ...
                        <LazyLoad height={200} offset={100}>
                            ...
                            <script>
                              window.googletag = window.googletag || {cmd: []};
                              googletag.cmd.push(function() {
                                googletag.defineSlot('/22515155853/tv9_hindi_UP_RJ_19', [300, 250], 'div-gpt-ad-23127116743').addService(googletag.pubads());
                                googletag.pubads().enableSingleRequest();
                                googletag.enableServices();
                              });
                            </script>
                            <div class="ad"><!-- /23127116746 -->
                            <div id='div-gpt-ad-23127116746' style='min-width: 300px; min-height: 250px;'>
                                <script>
